...
Transistor_FET_Nchannel::Transistor_FET_Nchannel() : ElectronicComponent(150, 200, "FET N-channel Transistor", 0){}
...
void Transistor_FET_Nchannel::Show(){
    ...
    int poits[] = {
             int(center_x + height / 20), int(center_y + height / 15),
             int(center_x - height / 30), int(center_y + height / 15 + height / 30),
             int(center_x - height / 30), int(center_y + height / 15 - height / 30)};
    ...
    if(height / 50 > 1.7){
        ...
        outtextxy(up_left_x + height / 20, center_y + height / 15 + height / 20, "G");
        outtextxy(down_right_x - height / 6 - height / 5 - 5, down_right_y - height / 40 - height / 6, "S");
    }

    line(up_left_x + height / 20, center_y + height / 15, center_x + height / 20, center_y + height / 15);
